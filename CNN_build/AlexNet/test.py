...
if __name__ == "__main__":
    AlexNet  = AlexNet()
    AlexNet.load_state_dict(torch.load(r"D:\Codes\VSCode\DeepLearning\CNN_build\AlexNet\AlexNet.pth", weights_only=True))
    test_data_loader = test_data_process()
    test_model_process(AlexNet,test_data_loader)