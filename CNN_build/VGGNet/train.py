...
from VGGNetModel import VGGNet
import time
import pandas as pd
import copy
import os
...
def train_model_process(model,train_dataloader,val_dataloader,epochs):
    ...
    torch.save(best_weights,r"D:\Codes\VSCode\DeepLearning\CNN_build\VGGNet\VGGNet.pth")
...
def plot_train_process(train_process):
    ...
    plt.savefig(r"C:\Users\徐林智\Desktop\VGGNet.png")
    plt.close()
