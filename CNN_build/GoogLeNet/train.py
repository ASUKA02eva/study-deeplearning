...
from GoogLeNetModel import GoogLeNet, Inception
import time
import pandas as pd
import copy
import os
...
def train_model_process(model,train_dataloader,val_dataloader,epochs):
    ...
    torch.save(best_weights, r"D:\Codes\VSCode\DeepLearning\CNN_build\GoogLeNet\GoogLeNet.pth")
...
def plot_train_process(train_process):
    ...
    plt.savefig(r"C:\Users\徐林智\Desktop\GoogLeNet.png")
    plt.close()
