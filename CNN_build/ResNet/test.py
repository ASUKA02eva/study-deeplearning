...
if __name__ == "__main__":
    ResNet  = ResNet18()
    ResNet.load_state_dict(torch.load(r"D:\Codes\VSCode\DeepLearning\CNN_build\ResNet\ResNet.pth", weights_only=True))
    test_data_loader = test_data_process()
    test_model_process(ResNet,test_data_loader)